...
const ExtendedFamilyPayment = ({
    monthlyPremium,
    extendedPaymentMethod,
    setExtendedPaymentMethod,
    extendedMonthlyPremium,
    setExtendedMonthlyPremium,
    armsOfService,
    extendedBankingDetailsDO,
    setExtendedBankingDetailsDO,
    premium, premium2, premium3, premium4, premium5, premium6, premium7, premium8 }) => {
    ...
    setExtendedMonthlyPremium(premium + premium2 + premium3 + premium4 + premium5 + premium6 + premium7 + premium8 + 10);
    ...
    const requiredSubmitted = () => {
        ...
        } else if (extendedPaymentMethod == 'DebitOrder') {
            if (bankName != '') {
                if (bankName == 'ABSA') {
                    branch = '632005'
                }
    ...
    useEffect(() => {
        ...
        if (extendedPaymentMethod == 'DebitOrder') {
            setDebitOrder(true)
            var now = new Date();
            var elements = [];
            let number = new Date(now.getFullYear(), now.getMonth() + 1, 0).getDate();
    ...
    }, [extendedPaymentMethod, setExtendedPaymentMethod])
        ...
        <div className="page">
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <p style={{
                    textAlign: 'center',
                    fontWeight: '600'
                }}>*Wider Family Monthly Premium: R{extendedMonthlyPremium}.00</p>
                <Form>
                    <Form.Group className='mb-2' controlId='extendedPaymentMethod'>
                        <Form.Label className='Label'>
                            Payment Method
                        </Form.Label>
                        <Form.Select value={extendedPaymentMethod} onChange={(e) => setExtendedPaymentMethod(e.target.value)} >
                ...
                <div className='page' id='paymentTerms' >
                    {!debitOrder && <p style={{
                        ...
                        I authorise the Accountant of the Department of Defence to deduct the monthly payments from my salary as per the above authority provided and remit it to the Shield Life Limited of which I am a member,  each and every month and continuing until cancelled by me in writing or until I substitute it with a new authorisation.  I have read and accepted the terms and conditions as set out below.
                        <br />
                        <br />
                        <em style={{
                            textAlign: 'center',
                        ...
                        Should the premium rate be adjusted by the Shield Life Limited as a result of a general decrease/increase in subscription or should I request the Shield Life Limited to decrease/increase the premium for certain reason, I confirm that the adjusted premium may be deducted.
                ...
                {debitOrder && <Form>
                    ...
                    <Form.Group className='mb-2' controlId='bankName'>
                        ...
                        <Form.Select value={extendedBankingDetailsDO.Bank} onChange={(e) => setBankName(e.target.value)}>
                    ...
                    <Row>
                        <Col lg="2">
                            <Form.Group className='mb-2' controlId='accountNumber'>
                                <Form.Label className='Label'>Day of month for Debit Order</Form.Label>
                                <Form.Select value={selectDay} onChange={(e) => setSelectDay(e.target.value)}>
                ...
                {debitOrder && <p style={{
                    ...
                    I authorise the Shield Life Limited to deduct the monthly payments from this account as per the above authority provided. I have read and accepted the debit order terms and conditions as set out below.
                    <br />
                    <br />
                    <em style={{
                        textAlign: 'center',
                    ...
                    <br />
                    <br />
                    I instruct and authorise the Shield Life Limited to draw against my nominated bank account (or any other bank or branch to which I may transfer my account) the
                    <br />
                    ...
                    I agree that should there be insufficient funds in my account to meet the obligation, the Shield Life Limited are entitled  to track my account and re-present the instruction for payment as soon as sufficient funds are available in my account. Such will contain the Shield Life Limited as reference which shall enable me to match the withdrawals with this Membership agreement.
                    I agree to pay any bank charges relating to this debit order instruction.
                    Should the premium rate be adjusted by the Shield Life Limited as a result of a general decrease/increase in subscription or should I request the Shield Life Limited to decrease/increase the premium for certain reason, I confirm that the adjusted premium may be deducted from my bank account.
                    I acknowledge that this Authority may be ceded or assigned to a third party for collection purposes.
                </p>}
                ...
                {showNext && <Link to='/checkInfo'>
                    <Button variant='danger w-25' onClick={() => console.log(extendedBankingDetailsDO)} style={{ fontWeight: '600', background: '#BB1A1B', border: 'none', float: 'right', marginTop: '10vw', marginRight: '20vw' }} >NEXT</Button>
                </Link>}
...
export default ExtendedFamilyPayment